  ...
  return (
    <div className="space-y-10">
      ...
      <section id="section-2" className="space-y-4">
        ...
        <p className="text-sm text-zinc-400 leading-relaxed">
          2020年+48.8%、2023年+53.8%など高いリターンを記録する年がある一方、2022年は約-37%と大幅下落した年もあります。金融株を含まないため、S&P500よりもテクノロジー分野への集中度が高い構造です。
        </p>
      </section>
        ...
        <div className="space-y-3">
          {[
            ...
            },
            {
              ...
              body: "NASDAQ100は約-37%の下落。S&P500は約-18%に留まりました。金利上昇局面ではグロース株中心のNASDAQ100が特に大きな影響を受けます。",
