...
const SECTIONS = [
  {
    title: "サービスの目的",
    body: "本サービス「積立タイムマシン」は、一次情報から検証した月次実績を中心に、積立投資の過去結果を比較するシミュレーションおよび情報提供を目的として運営されています。",
  },
  {
    title: "投資助言ではありません",
  ...
  {
    title: "情報の正確性について",
    body: "掲載している情報の正確性・完全性・有用性を保証するものではありません。A系列は一次情報から検証した月次実績を使用し、G系列は参考データとして品質を明示しています。いずれも将来の運用成果を示すものではありません。",
  },
  {
    title: "免責事項",
