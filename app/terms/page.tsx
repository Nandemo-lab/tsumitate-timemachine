...
const SECTIONS = [
  {
    title: "サービスの目的",
    body: "本サービス「積立タイムマシン」は、年次参考系列を月次換算した積立投資の簡易シミュレーションおよび情報提供を目的として運営されています。",
  },
  {
    title: "投資助言ではありません",
  ...
  {
    title: "情報の正確性について",
    body: "掲載している情報の正確性・完全性・有用性を保証するものではありません。VTは公式月次NAVリターンと日本銀行の月末為替を使用し、その他の系列は原典未特定の年次参考系列による簡易計算です。いずれも将来の運用成果を示すものではありません。",
  },
  {
    title: "免責事項",
