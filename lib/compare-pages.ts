...
export const COMPARE_PAGES: ComparePage[] = [
  ...
  // ── S&P500 vs NASDAQ100 ───────────────────────────────────────────
  {
    ...
    specs: [
      ...
      { label: "最大下落幅",    a: "約−33%（2020年コロナ）",       b: "約−33%（2022年）" },
  ...
  // ── VTI vs オルカン ───────────────────────────────────────────────
  {
    ...
    simAmount: 30000,
    specs: [
      { label: "投資対象",      a: "米国全株式（約3,700銘柄）",    b: "全世界株式（約3,000銘柄）" },
  ...
  // ── NASDAQ100 vs FANG+ ────────────────────────────────────────────
  {
    ...
    specs: [
      ...
      { label: "最大下落幅",    a: "約−33%（2022年）",             b: "約−44%（2022年）" },
  ...
  // ── VTI vs S&P500 ──────────────────────────────────────────────────
  {
    ...
    simAmount: 30000,
    specs: [
      { label: "投資対象",      a: "米国株式全体（約3,700銘柄）",      b: "米国大型株（500銘柄）" },
      { label: "形式",          a: "ETF（株式市場でリアルタイム売買）", b: "投資信託（毎日基準価格）" },
