...
export const FUNDS: Record<FundId, Fund> = {
  ...
  vt: {
    ...
    encyclopedia: {
      ...
      pros: ["全世界約10,000銘柄をカバー", "バンガード社の信頼性", "流動性が高い"],
  ...
  sp500: {
    ...
    encyclopedia: {
      ...
      pros: ["米国を代表する大型株500社へ分散", "米国の主要な大型成長企業が主力", "信託報酬が超低コスト"],
  ...
  vti: {
    ...
    encyclopedia: {
      ...
      features: ["🇺🇸 米国全体", "📊 約3,500銘柄", "💼 バンガード運用"],
  ...
  nasdaq100: {
    ...
    encyclopedia: {
      ...
      pros: ["米国の非金融大型株100社へ投資", "米国の主要テクノロジー・成長企業が主力", "イノベーション分野の比率が高い"],
  ...
  emerging: {
    ...
    encyclopedia: {
      ...
      cons: ["地政学リスク・政治リスクが高い", "国・通貨・政策変更の影響を受ける"],
      managementFee: "0.72%（年率）",
      beginnerScore: 2,
      volatility: "高",
      expectedHorizon: "15年以上",
      nisaSupport: { tsumitate: false, growth: true },
