...
export const RANKING_PAGES: RankingPageData[] = [
  ...
  {
    slug: "high-return",
    metaTitle: "リターン重視おすすめ積立ランキング【最新】NASDAQ100・FANG+・S&P500比較",
    metaDescription:
      "高リターンを狙う投資家向けランキング。NASDAQ100・FANG+・S&P500を過去実績・リターン率で比較→今すぐ確認",
    h1: "リターン重視おすすめランキング【最新版】",
    intro:
  ...
  {
    slug: "high-dividend",
    metaTitle: "高配当ETFランキング【最新】SCHD vs VYM配当利回り・積立実績を比較",
    metaDescription:
      "SCHD（楽天SCHD）とVYMを配当利回り・増配率・積立実績で比較ランキング。老後の収入源づくりに向いている高配当ETFを今すぐ確認→",
    h1: "高配当ETFランキング【最新版】SCHD vs VYM",
    intro:
